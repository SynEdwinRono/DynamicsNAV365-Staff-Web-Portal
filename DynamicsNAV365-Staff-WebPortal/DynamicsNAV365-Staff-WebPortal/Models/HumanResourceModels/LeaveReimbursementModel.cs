...
namespace DynamicsNAV365_Staff_WebPortal.Models.HumanResourceModels
{
    public class LeaveReimbursementModel
    {
        ...
        [Display(Name = "LeaveApplication No.")]
        [Required(AllowEmptyStrings = false, ErrorMessage = "LeaveApplication No.Required")]
        ...
        public decimal ReimbursementDays { get; set; }

        [Display(Name = "Reason For Reimbursement")]
        public string ReimbersementReason { get; set; }
