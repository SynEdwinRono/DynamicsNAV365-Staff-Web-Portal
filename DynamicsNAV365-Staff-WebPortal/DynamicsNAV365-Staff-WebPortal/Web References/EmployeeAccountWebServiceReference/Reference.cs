...
namespace DynamicsNAV365_Staff_WebPortal.EmployeeAccountWebServiceReference {
    using System;
    ...
    public partial class EmployeeAccountWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public EmployeeAccountWebService() {
            this.Url = global::DynamicsNAV365_Staff_WebPortal.Properties.Settings.Default.DynamicsNAV365_Staff_WebPortal_EmployeeAccountWebServiceReference_EmployeeAccountWebService;
        ...
        public bool EmployeeExists(string employeeNoa46) {
        ...
        /// <remarks/>
        public void EmployeeExistsAsync(string employeeNoa46) {
            this.EmployeeExistsAsync(employeeNoa46, null);
        }
        
        /// <remarks/>
        public void EmployeeExistsAsync(string employeeNoa46, object userState) {
            ...
            this.InvokeAsync("EmployeeExists", new object[] {
                        employeeNoa46}, this.EmployeeExistsOperationCompleted, userState);
        }
